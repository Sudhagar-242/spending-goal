...
// import ProductModal from 'app/components/productsModal';
...
// import SpendingGoalWidget from 'app/components/';
// import GoalCard from 'app/components/goal_card';
// import GoalEditModal from 'app/components/modals/goalEditModal';
// import ProductModal from 'app/components/modals/productsModal';
...
// // --- React UI ---
// export default function SpendingGoalPage() {
//   const { shopId, currencyCode, goalDiscountArray, products, error } = useLoaderData<typeof loader>();
//   const fetcher = useFetcher<typeof action>();
//   const submitting = fetcher.state !== 'idle' && fetcher?.formData?.get('actionType') === DiscountGoals.ADD;
//   const [goalName, setGoalName] = useState<string>('');
//   const [goal, setGoal] = useState<string>('');
//   const [discount, setDiscount] = useState<string>('');
//   const [toastOpen, setToastOpen] = useState(false);
...
//   return (
//     <Frame>
//       <Page title="Cart Spending Goals" backAction={{ content: 'Back', url: '/' }}>
//         <BlockStack gap="400">
//           <Card>
//       <Tabs tabs={tabs} selected={selected} onSelect={handleTabChange}>
//         {tabs[selected].content === "product" ? (
//           <ProductGoalForm />
//         ): tabs[selected].content === "order" ? (
//           <OrderGoalForm />
//         ): tabs[selected].content === "shipping" ? (
//           <ShippingGoalForm />
//         ): (
//           <Text as="p"> No Content</Text>
//         )}
//       </Tabs>
//           </Card>
//           <Card>
...
//               <Card>
//               <BlockStack>
//                 <Button onClick={() => setOpenProductsModal(true)}>Open Product Modal</Button>
