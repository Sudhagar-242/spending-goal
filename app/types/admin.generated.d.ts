...
export type ShopAndCartGoalQuery = { shop: (
    Pick<AdminTypes.Shop, 'id' | 'currencyCode'>
...
export type SetGoalDiscountsMutation = { metafieldsSet?: AdminTypes.Maybe<{ metafields?: AdminTypes.Maybe<Array<Pick<AdminTypes.Metafield, 'id' | 'namespace' | 'key' | 'value'>>>, userErrors: Array<Pick<AdminTypes.MetafieldsSetUserError, 'field' | 'message'>> }> };

interface GeneratedQueryTypes {
  "#graphql\n  query ShopAndCartGoal {\n    shop {\n      id\n      currencyCode\n      metafield(namespace: \"spending_goal\", key: \"goal_discounts\") {\n        id\n        value\n        type\n      }\n    }\n  }\n": {return: ShopAndCartGoalQuery, variables: ShopAndCartGoalQueryVariables},
}
